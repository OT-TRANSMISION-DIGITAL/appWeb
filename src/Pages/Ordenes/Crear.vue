<!-- 
    asi debe estar el json de las ordenes
    {
    "fechaHoraSolicitud": "2024-07-05 10:00:00",
    "fechaHoraLlegada": "2024-07-05 11:00:00",
    "fechaHoraSalida": "2024-07-05 12:00:00",
    "persona_solicitante": "Marcela Castorena",
    "puesto": "Gerente",
            ...
            <div class="grid grid-cols-2 gap-10 mt-5">
                ...
                <div class="col-span-1">
                    <Input v-model="form.fechaHoraLlegada.value" label="Fecha de Llegada" placeholder="Fecha de Llegada"
                        type="date" id="fechaHoraLlegada" name="fechaHoraLlegada"
                ...
                <div class="col-span-1">
                    <Input v-model="form.fechaHoraSalida.value" label="Fecha de Salida" placeholder="Fecha de Salida"
                        type="date" id="fechaHoraSalida" name="fechaHoraSalida"
                        :validation-status="form.fechaHoraSalida.error.status"
                        :validation-message="form.fechaHoraSalida.error.message" />
                </div>
                <div class="col-span-1">
                    <Input v-model="form.direccion.value" label="Dirección" placeholder="Dirección" type="email"
...
const submit = async (e) => {
    ...
    const data = {
        ...
        fechaHoraSolicitud: new Date(form.value.fechaHoraSolicitud.value).toISOString().split('.')[0].replace('T', ' '),
        fechaHoraLlegada: form.value.fechaHoraLlegada.value ? new Date(form.value.fechaHoraLlegada.value).toISOString().split('.')[0].replace('T', ' ') : null,
        fechaHoraSalida: form.value.fechaHoraSalida.value ? new Date(form.value.fechaHoraSalida.value).toISOString().split('.')[0].replace('T', ' ') : null,
